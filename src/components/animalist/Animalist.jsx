...
import imh from "../../../src/assets/meow.mp3"
export const Animalist = () => {
  // Функция для проигрывания звука
  const playSound = (soundUrl) => {
    const audio = new Audio(soundUrl); // создаем новый объект Audio
    ...
    <>
        ...
        <div className="flex gap-4 font-semibold flex-nowrap">
          <div className="flex flex-col items-center">
            <img
              ...
              alt="Тигр"
              onClick={() => playSound('../../../src/assets/meow.mp3')} // добавляем обработчик клика для звука
            />
          ...
          <div className="flex flex-col items-center">
            <img
              ...
              alt="Сигмо"
              onClick={() => playSound('p../../../src/assets/meow.mp3')} // добавляем обработчик клика для звука
            />
          ...
          <div className="flex flex-col items-center">
            <img
              ...
              alt="Милое имя"
              onClick={() => playSound('')} // добавляем обработчик клика для звука
            />
      ...
      <div className="flex justify-center mt-5 hover:scale-90 transition-transform duration-300">
        <button className="px-6 py-2 bg-blue-500 text-white font-semibold rounded-lg hover:border-l-cyan-800 shadow-md hover:bg-blue-600">
          Показать больше
        </button> <img className="w-16 h-16 ml-4 object-cover" src=""/>
      </div>
    </>
  );
};
